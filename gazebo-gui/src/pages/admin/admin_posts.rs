    ...
    html! {
        <main id={crate::consts::CSS_ID_ADMIN_AREA} class={"text-[#3c352d]"}>
            ...
            <div class={"flex"}>
                ...
                <section class="bg-[#faf7f2] w-full">
                    <h2 class="font-bold ">{"POST ENTRIES"}</h2>
                    <div class="flex w-full bg-gray-100 border">
                        <ButtonAddNewEntry />
                        <button class="px-4 py-2 mr-px hover:bg-blue-500">{"Publish"}</button>
                        <button class="px-4 py-2 mr-px hover:bg-blue-500">{"Draft"}</button>
                        <button class="px-4 py-2 mr-px hover:bg-blue-500">{"Bin"}</button>
